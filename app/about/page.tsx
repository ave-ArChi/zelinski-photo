export default function AboutPage() {
  return (
    <section className="pt-6 space-y-6 max-w-2xl">
      <h1 className="text-xl tracking-wide uppercase">About & Contacts</h1>
      <p className="text-neutral-700 whitespace-pre-line">
Привет! Меня зовут Мадина, я профессиональный фотограф и ретушер.
